...
const GET_TOILET_RATINGS_QUERY = `SELECT ${RATINGS_TABLE_NAME}.rating, ${RATINGS_TABLE_NAME}.text, ${USERS_TABLE_NAME}.username FROM ${RATINGS_TABLE_NAME} INNER JOIN ${USERS_TABLE_NAME} ON {RATINGS_TABLE_NAME}.uID=${USERS_TABLE_NAME}.uID WHERE ${RATINGS_TABLE_NAME}.tID = ?`;
